...
class TestLogger(unittest.TestCase):
    ...
    def test_001_is_logger_initialized(self) -> None:
        logger = Logger(name=__name__, file_name=f"{self.test_001_is_logger_initialized.__name__}.log")
        self.assertIsNotNone(logger)
        logger.exit_logger()

    # Is cache folder is created
    def test_002_is_cache_generated(self) -> None:
        Logger(name=__name__, file_name=f"{self.test_002_is_cache_generated.__name__}.log").exit_logger()
    ...
    def test_003_is_log_file_generated(self) -> None:
        ...
        Logger(name=__name__, file_name=f"{test_name}.log").exit_logger()
    ...
    def test_004_is_logger_not_accessible_after_exit(self) -> None:
        ...
        logger = Logger(name=__name__, file_name=f"{test_name}.log")
    ...
    def test_005_is_logger_accessible_after_restarting(self) -> None:
        ...
        try:
            logger = Logger(name=__name__, file_name=f"{test_name}.log", debug=True)
            logger.log(message=test_name)
    ...
    def test_006_check_for_total_log_count(self) -> None:
        logger = Logger(name=__name__, file_name=self.test_006_check_for_total_log_count.__name__)
    ...
    def test_007_logger_each_log_level_count(self) -> None:
        logger = Logger(name=__name__, file_name=f"{self.test_007_logger_each_log_level_count.__name__}.log")
    ...
    def test_008_is_logger_really_stopped(self) -> None:
        logger = Logger(name=__name__, file_name=f"{self.test_008_is_logger_really_stopped.__name__}.log")
